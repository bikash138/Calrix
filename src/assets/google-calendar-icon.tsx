...
export function GoogleCalendarIcon({ style, className }: { style?: React.CSSProperties; className?: string }) {
  const id = useId();
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 192 192" style={style} className={className}>
      ...
      <mask id={`${id}-a`} width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }}>
        <path fill="#3c90ff" d="M19.867 49.392C17.818 33.82 29.94 20 45.645 20h100.71c15.706 0 27.827 13.82 25.778 29.392L166 96l6.133 46.608C174.182 158.18 162.061 172 146.355 172H45.645c-15.706 0-27.827-13.82-25.778-29.392L26 96z" />
      </mask>
      <g mask={`url(#${id}-a)`}>
      ...
      <defs>
        <linearGradient id={`${id}-b`} x1="83" x2="83" y1="76" y2="0" gradientUnits="userSpaceOnUse">
