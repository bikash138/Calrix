...
Autonomy levels:
- auto_safe: The AI can act without asking the user. Only for low-stakes, fully reversible actions where the intent is unambiguous.
  Examples: declining a meeting you're clearly unavailable for, sending "got it, thanks", nudging your own unanswered thread.
...
Rules:
- When in doubt, go up a level (needs_review over auto_safe, needs_approval over needs_review)
